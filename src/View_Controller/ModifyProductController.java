...
public class ModifyProductController implements Initializable {
    ...
    public void addAssociatedPartButtonPushed(javafx.event.ActionEvent event) {
    ...
    public void modifyProductCancelButtonPushed(ActionEvent event) {
        Alert alert = new Alert(Alert.AlertType.CONFIRMATION);
        alert.setTitle("Cancel Modify Produc");
    ...
    public void modifyProductSaveButtonPushed(javafx.event.ActionEvent event) throws IOException {
    ...
    // receives product from main controller, then loads in data to fields
